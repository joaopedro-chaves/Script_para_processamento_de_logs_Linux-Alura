# Scripts para processamento de arquivos de logs

Este repositório é destinado a exibir o projeto final no "Curso de Linux: criando script para processamento de arquivos de logs" da Alura
...
This repository is showcase to display the final project for the "Linux Course: Scripting for Log File Processing" from Alura.
